...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Redirect handled by page.tsx after profile loads
      router.push("/");
    } catch (err: any) {
    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .logo-sub { font-size: 12px; color: #5a5a70; letter-spacing: 2px; text-transform: uppercase; margin-top: 4px; }
        .login-title { font-family: 'Syne', sans-serif; font-size: 22px; font-weight: 700;
          color: #f0f0f8; margin: 28px 0 6px; }
        .login-sub { font-size: 13px; color: #9090a8; margin-bottom: 28px; }
        .field { margin-bottom: 16px; }
        .field label { display: block; font-size: 12px; color: #9090a8; font-weight: 600;
          text-transform: uppercase; letter-spacing: 1px; margin-bottom: 8px; }
        .field input {
          width: 100%; padding: 12px 14px;
          background: #1a1a24; border: 1px solid rgba(255,255,255,0.1);
          border-radius: 8px; color: #f0f0f8; font-size: 14px;
        ...
        .btn-login:hover { background: #7c73ff; transform: translateY(-1px); }
        ...
        .hint { font-size: 12px; color: #5a5a70; text-align: center; }
        .hint span { color: #a78bfa; }
      `}</style>
      <div className="login-wrap">
        <div className="login-card">
          ...
          <div className="hint">
            Admin · Trainer · Client — same login, role auto-detected<br />
